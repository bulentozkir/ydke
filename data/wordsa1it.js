...
window.WORDS_IT_A1 = [
  ...
  { word: "essere", pos: "verb", level: "A1", category: "General", definition: "To be. - Olmak.", example: "Io sono molto felice di vederti. - Seni gördüğüme çok mutluyum." },
  { word: "avere", pos: "verb", level: "A1", category: "General", definition: "To have. - Sahip olmak.", example: "Ho una bicicletta nuova. - Yeni bir bisikletim var." },
  { word: "andare", pos: "verb", level: "A1", category: "General", definition: "To go. - Gitmek.", example: "Vado a scuola a piedi ogni mattina. - Her sabah okula yürüyerek gidiyorum." },
  { word: "fare", pos: "verb", level: "A1", category: "General", definition: "To do / make. - Yapmak.", example: "Faccio i compiti dopo pranzo. - Öğle yemeğinden sonra ödevlerimi yapıyorum." },
  ...
  { word: "bere", pos: "verb", level: "A1", category: "Food", definition: "To drink. - İçmek.", example: "Bevo un bicchiere di latte fresco. - Bir bardak taze süt içiyorum." },
  ...
  { word: "vedere", pos: "verb", level: "A1", category: "General", definition: "To see. - Görmek.", example: "Vedo molti fiori colorati nel parco. - Parkta birçok renkli çiçek görüyorum." },
  { word: "venire", pos: "verb", level: "A1", category: "General", definition: "To come. - Gelmek.", example: "Vieni alla mia festa di compleanno? - Doğum günü partime geliyor musun?" },
  { word: "potere", pos: "verb", level: "A1", category: "General", definition: "Can / to be able to. - Yapabilmek.", example: "Posso entrare, per favore? - İçeri girebilir miyim, lütfen?" },
  { word: "volere", pos: "verb", level: "A1", category: "General", definition: "To want. - İstemek.", example: "Voglio mangiare una pizza margherita. - Bir margarita pizza yemek istiyorum." },
  { word: "dovere", pos: "verb", level: "A1", category: "General", definition: "Must / to have to. - Zorunda olmak.", example: "Devo studiare per l'esame di domani. - Yarınki sınav için çalışmak zorundayım." },
