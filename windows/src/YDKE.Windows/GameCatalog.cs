...
internal static class GameCatalog
{
    ...
    [
        ...
        Complex("codycross", "CodyCross", "Beş ipucunu çözerek bonus kodu çıkarın.", "Solve five themed clues to reveal a bonus code.", "", GameMechanic.ClueWords),
        Complex("crossword", "Crossword", "İpuçlarıyla yerel çapraz bulmacayı tamamlayın.", "Complete a generated crossword from vocabulary clues.", "", GameMechanic.Crossword),
        ...
        Complex("scrabble", "Scrabble", "Harf taşlarıyla puanlı kelimeler oluşturun.", "Build scoring words from a letter rack.", "", GameMechanic.Scrabble),
