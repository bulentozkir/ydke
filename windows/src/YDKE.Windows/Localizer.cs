    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Resources =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["tr"] = Text(
                ...
                ("Cards.Meaning", "Anlam"), ("Cards.Listen", "Dinle"),
                ("Cards.Example", "Örnek"), ("Cards.Previous", "Önceki kart"),
                ("Cards.Next", "Sonraki kart"), ("Cards.Known", "Öğrendim"),
                ("Cards.Favorite", "Favori"), ("Quiz.Title", "Hızlı Test"),
                ("Quiz.Question", "Doğru kelimeyi seçin"), ("Quiz.Previous", "Önceki"),
                ("Quiz.Next", "Sonraki"), ("Quiz.Example", "Örnek"),
                ...
                ("Game.Hint", "İpucu"), ("Game.HintText", "Kelimenin bağlamını düşünün ve kısa bir ipucu için anlamına odaklanın."),
                ...
                ("Profile.SignOut", "Bağlantıyı kes"),
                ("Profile.Connected", "Bağlı"), ("Profile.Disconnected", "Bağlı değil"),
                ("Profile.CloudSynced", "İlerlemeniz bu cihazdaki bulut profiline kaydedildi."),
                ("Help.Title", "Yardım"),
            ...
            ["en"] = CaptureEnglish(Text(
                ...
                ("Cards.Reveal", "Reveal meaning"), ("Cards.Meaning", "Meaning"),
                ("Cards.Listen", "Listen"), ("Cards.Example", "Example"),
                ("Cards.Previous", "Previous card"), ("Cards.Next", "Next card"),
                ("Cards.Known", "I know this"), ("Cards.Favorite", "Favorite"),
                ("Quiz.Title", "Quick Quiz"), ("Quiz.Question", "Choose the correct word"),
                ("Quiz.Previous", "Previous"), ("Quiz.Next", "Next"), ("Quiz.Example", "Example"),
                ("Words.Title", "Word Library"),
                ...
                ("Game.Hint", "Hint"), ("Game.HintText", "Think about the word in context and focus on its meaning for a quick clue."),
                ...
                ("Profile.SignOut", "Disconnect"),
                ("Profile.Connected", "Connected"), ("Profile.Disconnected", "Not connected"),
                ("Profile.CloudSynced", "Your progress was saved to the cloud profile on this device."),
                ("Help.Title", "Help"),
